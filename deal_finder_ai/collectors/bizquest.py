...
def collect_sample_listings() -> list[Listing]:
    ...
    return [
        Listing(
            ...
            source="BizQuest",
            listing_url="https://www.bizquest.com/businesses-for-sale/?q=bHQ9MzAsNDAsODA%3D",
            ...
            raw={"sample_id": "new-york-commercial-cleaning"},
        ),
        Listing(
            ...
            raw={"sample_id": "remote-ecommerce-wellness"},
        ),
        Listing(
            title="Passenger Transportation Business in Queens",
            source="BizQuest",
            listing_url="https://www.bizquest.com/new-york-businesses-for-sale/",
            ...
            raw={"sample_id": "queens-passenger-transport"},
        ),
        Listing(
            title="Regional Restaurant Group",
            source="BizQuest",
            listing_url="https://www.bizquest.com/restaurants-for-sale/",
