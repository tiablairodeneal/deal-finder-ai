...
def _sample_listings_from_priority_sources() -> list[Listing]:
    return [
        Listing(
            ...
            listing_url="https://acquisitionsdirect.com/buy/",
            ...
            raw={"sample_id": "natural-wellness-ecommerce-brand"},
        ),
        Listing(
            title="Mobile App Portfolio With Subscription Revenue",
            source="AppBusinessBrokers",
            listing_url="https://www.appbusinessbrokers.com/buy/",
            ...
            raw={"sample_id": "mobile-app-portfolio"},
        ),
        Listing(
        ...
        Listing(
            ...
            source="BizBuySell",
            listing_url="https://www.bizbuysell.com/new-york-businesses-for-sale/",
            ...
            raw={"sample_id": "new-york-specialty-trades-contractor"},
        ),
        Listing(
            title="NYC Professional Services Firm",
            source="FirstChoice Business Brokers",
            listing_url="https://businessesforsaleinnewyorkcity.com/",
            ...
            raw={"sample_id": "professional-services-firm"},
        ),
        Listing(
            title="Remote B2B Content Marketing Agency",
            source="Merge",
            listing_url="https://gomerge.com/digital-agencies-for-sale/",
            ...
            raw={"sample_id": "b2b-content-marketing-agency"},
        ),
        Listing(
            title="Remote Education Content Business",
            source="QuietLight",
            listing_url="https://quietlight.com/listings/",
            ...
            raw={"sample_id": "education-content-business"},
        ),
        Listing(
            title="Healthcare E-Commerce Brand",
            source="Website Closers",
            listing_url="https://www.websiteclosers.com/businesses-for-sale/",
            industry="Healthcare",
            ...
            raw={"sample_id": "healthcare-ecommerce-brand"},
        ),
        Listing(
