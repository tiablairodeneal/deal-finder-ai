...
def classify_subindustry(listing: Listing) -> SubindustryClassification:
    ...
    rules = [
        ...
        ("Staffing", ["staffing", "recruiting", "employment agency"], False),
        ("Food Production & Packaging", ["food manufacturing", "food production", "food packaging", "co-packing", "copacking"], False),
        ("Distilleries & Alcohol Production", ["distillery", "brewery", "winery", "alcohol production"], False),
        ("Agricultural Production", ["farm", "agriculture", "agricultural"], False),
        ("Flooring", ["flooring", "floor covering"], False),
